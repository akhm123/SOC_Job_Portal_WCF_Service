<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="company.aspx.cs" Inherits="Jobportalclient.company" %>
		...
		<div class="wrap-contact100">
			...
			<form  runat="server" class="contact100-form validate-form">
                <div class="container-contact100-form-btn">
					 <asp:Button OnClick="Button1_Click" class="contact100-form-btn" ID="Button1" runat="server" Text="Postition posting" />
                   			
                </div>
                <div class="container-contact100-form-btn">
					 <asp:Button OnClick="Button2_Click" class="contact100-form-btn" ID="Button2" runat="server" Text="Select User by Company" />
                   			
                </div>
                <div class="container-contact100-form-btn">
					 <asp:Button OnClick="Button3_Click" class="contact100-form-btn" ID="Button3" runat="server" Text="Select user by Position" />
