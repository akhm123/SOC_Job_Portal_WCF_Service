<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="Jobportalclient.UserHome" %>
...
<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form  runat="server" class="contact100-form validate-form">
                ...
                <div class="container-contact100-form-btn">
					 <asp:Button OnClick="Button2_Click" class="contact100-form-btn" ID="Button2" runat="server" Text="Apply in Company" />
